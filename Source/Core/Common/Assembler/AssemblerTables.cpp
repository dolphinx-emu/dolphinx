...
constexpr OperandDesc ODesc_B = OperandDesc{Mask(16, 20), {11, false}};
...
constexpr OperandDesc ODesc_C = OperandDesc{Mask(21, 25), {6, false}};
...
constexpr OperandDesc ODesc_L = OperandDesc{Mask(10, 10), {21, false}};
...
constexpr OperandDesc ODesc_S = OperandDesc{Mask(6, 10), {21, false}};
...
extern const std::array<MnemonicDesc, NUM_MNEMONICS* VARIANT_PERMUTATIONS> mnemonics = {
    // A-2
    OERC_MNEMONIC(31, InsertVal(266, 22, 30), _D, _A, ODesc_B),  // add
    OERC_MNEMONIC(31, InsertVal(10, 22, 30), _D, _A, ODesc_B),   // addc
    OERC_MNEMONIC(31, InsertVal(138, 22, 30), _D, _A, ODesc_B),  // adde
    ...
    OERC_MNEMONIC(31, InsertVal(491, 22, 30), _D, _A, ODesc_B),  // divw
    OERC_MNEMONIC(31, InsertVal(459, 22, 30), _D, _A, ODesc_B),  // divwu
    RC_MNEMONIC(31, InsertVal(75, 22, 30), _D, _A, ODesc_B),     // mulhw
    RC_MNEMONIC(31, InsertVal(11, 22, 30), _D, _A, ODesc_B),     // mulhwu
    BASIC_MNEMONIC(7, _D, _A, _SIMM),                       // mulli
    OERC_MNEMONIC(31, InsertVal(235, 22, 30), _D, _A, ODesc_B),  // mullw
    OERC_MNEMONIC(31, InsertVal(104, 22, 30), _D, _A),      // neg
    OERC_MNEMONIC(31, InsertVal(40, 22, 30), _D, _A, ODesc_B),   // subf
    OERC_MNEMONIC(31, InsertVal(8, 22, 30), _D, _A, ODesc_B),    // subfc
    OERC_MNEMONIC(31, InsertVal(136, 22, 30), _D, _A, ODesc_B),  // subfe
    ...
    // A-3
    MNEMONIC(31, InsertVal(0, 21, 30), _Crfd, ODesc_L, _A, ODesc_B),   // cmp
    BASIC_MNEMONIC(11, _Crfd, ODesc_L, _A, _SIMM),                // cmpi
    MNEMONIC(31, InsertVal(32, 21, 30), _Crfd, ODesc_L, _A, ODesc_B),  // cmpl
    BASIC_MNEMONIC(10, _Crfd, ODesc_L, _A, _UIMM),                // cmpli

    // A-4
    RC_MNEMONIC(31, InsertVal(28, 21, 30), _A, ODesc_S, ODesc_B),   // and
    RC_MNEMONIC(31, InsertVal(60, 21, 30), _A, ODesc_S, ODesc_B),   // andc
    BASIC_MNEMONIC(28, _A, ODesc_S, _UIMM),                    // andi.
    BASIC_MNEMONIC(29, _A, ODesc_S, _UIMM),                    // andis.
    RC_MNEMONIC(31, InsertVal(26, 21, 30), _A, ODesc_S),       // cntlzw
    RC_MNEMONIC(31, InsertVal(284, 21, 30), _A, ODesc_S, ODesc_B),  // eqv
    RC_MNEMONIC(31, InsertVal(954, 21, 30), _A, ODesc_S),      // extsb
    RC_MNEMONIC(31, InsertVal(922, 21, 30), _A, ODesc_S),      // extsh
    RC_MNEMONIC(31, InsertVal(476, 21, 30), _A, ODesc_S, ODesc_B),  // nand
    RC_MNEMONIC(31, InsertVal(124, 21, 30), _A, ODesc_S, ODesc_B),  // nor
    RC_MNEMONIC(31, InsertVal(444, 21, 30), _A, ODesc_S, ODesc_B),  // or
    RC_MNEMONIC(31, InsertVal(412, 21, 30), _A, ODesc_S, ODesc_B),  // orc
    BASIC_MNEMONIC(24, _A, ODesc_S, _UIMM),                    // ori
    BASIC_MNEMONIC(25, _A, ODesc_S, _UIMM),                    // oris
    RC_MNEMONIC(31, InsertVal(316, 21, 30), _A, ODesc_S, ODesc_B),  // xor
    BASIC_MNEMONIC(26, _A, ODesc_S, _UIMM),                    // xori
    BASIC_MNEMONIC(27, _A, ODesc_S, _UIMM),                    // xoris

    // A-5
    RC_MNEMONIC(20, 0, _A, ODesc_S, _SH, _MB, _ME),  // rlwimi
    RC_MNEMONIC(21, 0, _A, ODesc_S, _SH, _MB, _ME),  // rlwinm
    RC_MNEMONIC(23, 0, _A, ODesc_S, ODesc_B, _MB, _ME),   // rlwnm

    // A-6
    RC_MNEMONIC(31, InsertVal(24, 21, 30), _A, ODesc_S, ODesc_B),    // slw
    RC_MNEMONIC(31, InsertVal(792, 21, 30), _A, ODesc_S, ODesc_B),   // sraw
    RC_MNEMONIC(31, InsertVal(824, 21, 30), _A, ODesc_S, _SH),  // srawi
    RC_MNEMONIC(31, InsertVal(536, 21, 30), _A, ODesc_S, ODesc_B),   // srw

    // A-7
    RC_MNEMONIC(63, InsertVal(21, 26, 30), _D, _A, ODesc_B),      // fadd
    RC_MNEMONIC(59, InsertVal(21, 26, 30), _D, _A, ODesc_B),      // fadds
    RC_MNEMONIC(63, InsertVal(18, 26, 30), _D, _A, ODesc_B),      // fdiv
    RC_MNEMONIC(59, InsertVal(18, 26, 30), _D, _A, ODesc_B),      // fdivs
    RC_MNEMONIC(63, InsertVal(25, 26, 30), _D, _A, ODesc_C),      // fmul
    RC_MNEMONIC(59, InsertVal(25, 26, 30), _D, _A, ODesc_C),      // fmuls
    RC_MNEMONIC(59, InsertVal(24, 26, 30), _D, ODesc_B),          // fres
    RC_MNEMONIC(63, InsertVal(26, 26, 30), _D, ODesc_B),          // frsqrte
    RC_MNEMONIC(63, InsertVal(20, 26, 30), _D, _A, ODesc_B),      // fsub
    RC_MNEMONIC(59, InsertVal(20, 26, 30), _D, _A, ODesc_B),      // fsubs
    RC_MNEMONIC(63, InsertVal(23, 26, 30), _D, _A, ODesc_C, ODesc_B),  // fsel

    // A-8
    RC_MNEMONIC(63, InsertVal(29, 26, 30), _D, _A, ODesc_C, ODesc_B),  // fmadd
    RC_MNEMONIC(59, InsertVal(29, 26, 30), _D, _A, ODesc_C, ODesc_B),  // fmadds
    RC_MNEMONIC(63, InsertVal(28, 26, 30), _D, _A, ODesc_C, ODesc_B),  // fmsub
    RC_MNEMONIC(59, InsertVal(28, 26, 30), _D, _A, ODesc_C, ODesc_B),  // fmsubs
    RC_MNEMONIC(63, InsertVal(31, 26, 30), _D, _A, ODesc_C, ODesc_B),  // fnmadd
    RC_MNEMONIC(59, InsertVal(31, 26, 30), _D, _A, ODesc_C, ODesc_B),  // fnmadds
    RC_MNEMONIC(63, InsertVal(30, 26, 30), _D, _A, ODesc_C, ODesc_B),  // fnmsub
    RC_MNEMONIC(59, InsertVal(30, 26, 30), _D, _A, ODesc_C, ODesc_B),  // fnmsubs

    // A-9
    RC_MNEMONIC(63, InsertVal(14, 21, 30), _D, ODesc_B),  // fctiw
    RC_MNEMONIC(63, InsertVal(15, 21, 30), _D, ODesc_B),  // fctiwz
    RC_MNEMONIC(63, InsertVal(12, 21, 30), _D, ODesc_B),  // frsp

    // A-10
    MNEMONIC(63, InsertVal(32, 21, 30), _Crfd, _A, ODesc_B),  // fcmpo
    MNEMONIC(63, InsertVal(0, 21, 30), _Crfd, _A, ODesc_B),   // fcmpu
    ...
    RC_MNEMONIC(63, InsertVal(711, 21, 30), _FM, ODesc_B),      // mtfsf
    RC_MNEMONIC(63, InsertVal(134, 21, 30), _Crfd, _IMM),  // mtfsfi

    // A-12
    BASIC_MNEMONIC(34, _D, _Offd, _A),                 // lbz
    BASIC_MNEMONIC(35, _D, _Offd, _A),                 // lbzu
    MNEMONIC(31, InsertVal(119, 21, 30), _D, _A, ODesc_B),  // lbzux
    MNEMONIC(31, InsertVal(87, 21, 30), _D, _A, ODesc_B),   // lbzx
    BASIC_MNEMONIC(42, _D, _Offd, _A),                 // lha
    BASIC_MNEMONIC(43, _D, _Offd, _A),                 // lhau
    MNEMONIC(31, InsertVal(375, 21, 30), _D, _A, ODesc_B),  // lhaux
    MNEMONIC(31, InsertVal(343, 21, 30), _D, _A, ODesc_B),  // lhax
    BASIC_MNEMONIC(40, _D, _Offd, _A),                 // lhz
    BASIC_MNEMONIC(41, _D, _Offd, _A),                 // lhzu
    MNEMONIC(31, InsertVal(311, 21, 30), _D, _A, ODesc_B),  // lhzux
    MNEMONIC(31, InsertVal(279, 21, 30), _D, _A, ODesc_B),  // lhzx
    BASIC_MNEMONIC(32, _D, _Offd, _A),                 // lwz
    BASIC_MNEMONIC(33, _D, _Offd, _A),                 // lwzu
    MNEMONIC(31, InsertVal(55, 21, 30), _D, _A, ODesc_B),   // lwzux
    MNEMONIC(31, InsertVal(23, 21, 30), _D, _A, ODesc_B),   // lwzx

    // A-13
    BASIC_MNEMONIC(38, ODesc_S, _Offd, _A),                 // stb
    BASIC_MNEMONIC(39, ODesc_S, _Offd, _A),                 // stbu
    MNEMONIC(31, InsertVal(247, 21, 30), ODesc_S, _A, ODesc_B),  // stbux
    MNEMONIC(31, InsertVal(215, 21, 30), ODesc_S, _A, ODesc_B),  // stbx
    BASIC_MNEMONIC(44, ODesc_S, _Offd, _A),                 // sth
    BASIC_MNEMONIC(45, ODesc_S, _Offd, _A),                 // sthu
    MNEMONIC(31, InsertVal(439, 21, 30), ODesc_S, _A, ODesc_B),  // sthux
    MNEMONIC(31, InsertVal(407, 21, 30), ODesc_S, _A, ODesc_B),  // sthx
    BASIC_MNEMONIC(36, ODesc_S, _Offd, _A),                 // stw
    BASIC_MNEMONIC(37, ODesc_S, _Offd, _A),                 // stwu
    MNEMONIC(31, InsertVal(183, 21, 30), ODesc_S, _A, ODesc_B),  // stwux
    MNEMONIC(31, InsertVal(151, 21, 30), ODesc_S, _A, ODesc_B),  // stwx

    // A-14
    MNEMONIC(31, InsertVal(790, 21, 30), _D, _A, ODesc_B),  // lhbrx
    MNEMONIC(31, InsertVal(534, 21, 30), _D, _A, ODesc_B),  // lwbrx
    MNEMONIC(31, InsertVal(918, 21, 30), ODesc_S, _A, ODesc_B),  // sthbrx
    MNEMONIC(31, InsertVal(662, 21, 30), ODesc_S, _A, ODesc_B),  // stwbrx

    // A-15
    BASIC_MNEMONIC(46, _D, _Offd, _A),  // lmw
    BASIC_MNEMONIC(47, ODesc_S, _Offd, _A),  // stmw

    // A-16
    MNEMONIC(31, InsertVal(597, 21, 30), _D, _A, _NB),  // lswi
    MNEMONIC(31, InsertVal(533, 21, 30), _D, _A, ODesc_B),   // lswx
    MNEMONIC(31, InsertVal(725, 21, 30), ODesc_S, _A, _NB),  // stswi
    MNEMONIC(31, InsertVal(661, 21, 30), ODesc_S, _A, ODesc_B),   // stswx

    // A-17
    MNEMONIC(31, InsertVal(854, 21, 30)),                                     // eieio
    MNEMONIC(19, InsertVal(150, 21, 30)),                                     // isync
    MNEMONIC(31, InsertVal(20, 21, 30), _D, _A, ODesc_B),                          // lwarx
    MNEMONIC(31, InsertVal(150, 21, 30) | InsertVal(1, 31, 31), ODesc_S, _A, ODesc_B),  // stwcx.
    MNEMONIC(31, InsertVal(598, 21, 30)),                                     // sync

    // A-18
    BASIC_MNEMONIC(50, _D, _Offd, _A),                 // lfd
    BASIC_MNEMONIC(51, _D, _Offd, _A),                 // lfdu
    MNEMONIC(31, InsertVal(631, 21, 30), _D, _A, ODesc_B),  // lfdux
    MNEMONIC(31, InsertVal(599, 21, 30), _D, _A, ODesc_B),  // lfdx
    BASIC_MNEMONIC(48, _D, _Offd, _A),                 // lfs
    BASIC_MNEMONIC(49, _D, _Offd, _A),                 // lfsu
    MNEMONIC(31, InsertVal(567, 21, 30), _D, _A, ODesc_B),  // lfsux
    MNEMONIC(31, InsertVal(535, 21, 30), _D, _A, ODesc_B),  // lfsx

    // A-19
    BASIC_MNEMONIC(54, ODesc_S, _Offd, _A),                 // stfd
    BASIC_MNEMONIC(55, ODesc_S, _Offd, _A),                 // stfdu
    MNEMONIC(31, InsertVal(759, 21, 30), ODesc_S, _A, ODesc_B),  // stfdux
    MNEMONIC(31, InsertVal(727, 21, 30), ODesc_S, _A, ODesc_B),  // stfdx
    MNEMONIC(31, InsertVal(983, 21, 30), ODesc_S, _A, ODesc_B),  // stfiwx
    BASIC_MNEMONIC(52, ODesc_S, _Offd, _A),                 // stfs
    BASIC_MNEMONIC(53, ODesc_S, _Offd, _A),                 // stfsu
    MNEMONIC(31, InsertVal(695, 21, 30), ODesc_S, _A, ODesc_B),  // stfsux
    MNEMONIC(31, InsertVal(663, 21, 30), ODesc_S, _A, ODesc_B),  // stfsx

    // A-20
    RC_MNEMONIC(63, InsertVal(264, 21, 30), _D, ODesc_B),  // fabs
    RC_MNEMONIC(63, InsertVal(72, 21, 30), _D, ODesc_B),   // fmr
    RC_MNEMONIC(63, InsertVal(136, 21, 30), _D, ODesc_B),  // fnabs
    RC_MNEMONIC(63, InsertVal(40, 21, 30), _D, ODesc_B),   // fneg
    ...
    // A-24
    MNEMONIC(31, InsertVal(4, 21, 30), _TO, _A, ODesc_B),  // tw
    ...
    MNEMONIC(31, InsertVal(144, 21, 30), _CRM, ODesc_S),  // mtcrf
    MNEMONIC(31, InsertVal(146, 21, 30), ODesc_S),        // mtmsr
    MNEMONIC(31, InsertVal(467, 21, 30), _SPR, _D),  // mtspr

    // A-26
    MNEMONIC(31, InsertVal(86, 21, 30), _A, ODesc_B),    // dcbf
    MNEMONIC(31, InsertVal(470, 21, 30), _A, ODesc_B),   // dcbi
    MNEMONIC(31, InsertVal(54, 21, 30), _A, ODesc_B),    // dcbst
    MNEMONIC(31, InsertVal(278, 21, 30), _A, ODesc_B),   // dcbt
    MNEMONIC(31, InsertVal(246, 21, 30), _A, ODesc_B),   // dcbtst
    MNEMONIC(31, InsertVal(1014, 21, 30), _A, ODesc_B),  // dcbz
    MNEMONIC(31, InsertVal(982, 21, 30), _A, ODesc_B),   // icbi

    // A-27
    MNEMONIC(31, InsertVal(595, 21, 30), _D, _SR),  // mfsr
    MNEMONIC(31, InsertVal(659, 21, 30), _D, ODesc_B),   // mfsrin
    MNEMONIC(31, InsertVal(210, 21, 30), _SR, ODesc_S),  // mtsr
    MNEMONIC(31, InsertVal(242, 21, 30), ODesc_S, ODesc_B),   // mtsrin

    // A-28
    MNEMONIC(31, InsertVal(306, 21, 30), ODesc_B),  // tlbie
    MNEMONIC(31, InsertVal(566, 21, 30)),      // tlbsync

    // A-29
    MNEMONIC(31, InsertVal(310, 21, 30), _D, _A, ODesc_B),  // eciwx
    MNEMONIC(31, InsertVal(438, 21, 30), ODesc_S, _A, ODesc_B),  // ecowx

    // A-30
    MNEMONIC(4, InsertVal(6, 25, 30), _D, _A, ODesc_B, _W2, _I2),   // psq_lx
    MNEMONIC(4, InsertVal(7, 25, 30), ODesc_S, _A, ODesc_B, _W2, _I2),   // psq_stx
    MNEMONIC(4, InsertVal(38, 25, 30), _D, _A, ODesc_B, _W2, _I2),  // psq_lux
    MNEMONIC(4, InsertVal(39, 25, 30), ODesc_S, _A, ODesc_B, _W2, _I2),  // psq_stux
    BASIC_MNEMONIC(56, _D, _OffdPs, _A, _W1, _I1),             // psq_l
    BASIC_MNEMONIC(57, _D, _OffdPs, _A, _W1, _I1),             // psq_lu
    BASIC_MNEMONIC(60, ODesc_S, _OffdPs, _A, _W1, _I1),             // psq_st
    BASIC_MNEMONIC(61, ODesc_S, _OffdPs, _A, _W1, _I1),             // psq_stu

    // A-31
    RC_MNEMONIC(4, InsertVal(18, 26, 30), _D, _A, ODesc_B),      // ps_div
    RC_MNEMONIC(4, InsertVal(20, 26, 30), _D, _A, ODesc_B),      // ps_sub
    RC_MNEMONIC(4, InsertVal(21, 26, 30), _D, _A, ODesc_B),      // ps_add
    RC_MNEMONIC(4, InsertVal(23, 26, 30), _D, _A, ODesc_C, ODesc_B),  // ps_sel
    RC_MNEMONIC(4, InsertVal(24, 26, 30), _D, ODesc_B),          // ps_res
    RC_MNEMONIC(4, InsertVal(25, 26, 30), _D, _A, ODesc_C),      // ps_mul
    RC_MNEMONIC(4, InsertVal(26, 26, 30), _D, ODesc_B),          // ps_rsqrte
    RC_MNEMONIC(4, InsertVal(28, 26, 30), _D, _A, ODesc_C, ODesc_B),  // ps_msub
    RC_MNEMONIC(4, InsertVal(29, 26, 30), _D, _A, ODesc_C, ODesc_B),  // ps_madd
    RC_MNEMONIC(4, InsertVal(30, 26, 30), _D, _A, ODesc_C, ODesc_B),  // ps_nmsub
    RC_MNEMONIC(4, InsertVal(31, 26, 30), _D, _A, ODesc_C, ODesc_B),  // ps_nmadd
    RC_MNEMONIC(4, InsertVal(40, 21, 30), _D, ODesc_B),          // ps_neg
    RC_MNEMONIC(4, InsertVal(72, 21, 30), _D, ODesc_B),          // ps_mr
    RC_MNEMONIC(4, InsertVal(136, 21, 30), _D, ODesc_B),         // ps_nabs
    RC_MNEMONIC(4, InsertVal(264, 21, 30), _D, ODesc_B),         // ps_abs

    // A-32
    RC_MNEMONIC(4, InsertVal(10, 26, 30), _D, _A, ODesc_C, ODesc_B),  // ps_sum0
    RC_MNEMONIC(4, InsertVal(11, 26, 30), _D, _A, ODesc_C, ODesc_B),  // ps_sum1
    RC_MNEMONIC(4, InsertVal(12, 26, 30), _D, _A, ODesc_C),      // ps_muls0
    RC_MNEMONIC(4, InsertVal(13, 26, 30), _D, _A, ODesc_C),      // ps_muls1
    RC_MNEMONIC(4, InsertVal(14, 26, 30), _D, _A, ODesc_C, ODesc_B),  // ps_madds0
    RC_MNEMONIC(4, InsertVal(15, 26, 30), _D, _A, ODesc_C, ODesc_B),  // ps_madds1
    MNEMONIC(4, InsertVal(0, 21, 30), _Crfd, _A, ODesc_B),       // ps_cmpu0
    MNEMONIC(4, InsertVal(32, 21, 30), _Crfd, _A, ODesc_B),      // ps_cmpo0
    MNEMONIC(4, InsertVal(64, 21, 30), _Crfd, _A, ODesc_B),      // ps_cmpu1
    MNEMONIC(4, InsertVal(96, 21, 30), _Crfd, _A, ODesc_B),      // ps_cmpo1
    RC_MNEMONIC(4, InsertVal(528, 21, 30), _D, _A, ODesc_B),     // ps_merge00
    RC_MNEMONIC(4, InsertVal(560, 21, 30), _D, _A, ODesc_B),     // ps_merge01
    RC_MNEMONIC(4, InsertVal(592, 21, 30), _D, _A, ODesc_B),     // ps_merge10
    RC_MNEMONIC(4, InsertVal(624, 21, 30), _D, _A, ODesc_B),     // ps_merge11
    MNEMONIC(4, InsertVal(1014, 21, 30), _A, ODesc_B),           // dcbz_l
};
